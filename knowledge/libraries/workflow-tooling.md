...
- [fact] Managed pre-commit flow split into ordered hooks: flake generation, statix, conditional Neovim lock, formatting, flake checks, knowledge reindex, hook reinstall
