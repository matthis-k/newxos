...
QtObject {
    ...
    function backendRootDto(children, options) {
        ...
        return Tokenize.makeNode(Object.assign({
            ...
            evaluationProfile: { mode: "generic", strategies: ["exact", "prefix", "compact", "substring", "acronym"], scorePolicy: "backend", profile: { evidence: [["field-match", { filterType: "all" }]], boost: [], childVisible: ["visible-flag"], tokenFlow: ["pass-all"], takeoverRequest: [], takeoverAccept: [], expand: [], retainParent: [], defaultAction: [], riskGate: [] } }
        }, opts));
    }
