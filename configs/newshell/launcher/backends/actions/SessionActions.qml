...
QtObject {
    ...
    function roots(context) { tracer.trace("roots", function() { return {}; }); return [{ id: "session", aliases: ["session", "system"], title: qsTr("Session"), icon: "system-shutdown-symbolic", template: "flat-action-group", behavior: { filterChildren: true }, evaluationProfile: EvalProfiles.EvaluationProfiles.groupProfile({ evidence: ["field-match", "semantic"] }), children: [
